...
<nav>
	...
	<li class="dropdown dropdown-mega">
					...
					<div class="container">
						<div class="row equal-height">
								...
								<ul class="list-unstyled equal-height-list dropdown-mega-sub-nav">
										...
										<!-- Typography -->
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-wrench fa-fw"></i> Builders</a></li>
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-leaf fa-fw"></i> Gardeners</a></li>
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-bolt fa-fw"></i> Electricians</a></li>
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-tint fa-fw"></i> Plumbers</a></li>
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-tree fa-fw"></i> Carpenters</a></li>
										<li><a class="nav-link" href="tradespeople.php"><i class="fas fa-paint-roller fa-fw"></i> Decorators</a></li>
										<!-- End Typography -->
									</ul>
								</div>
								<div class="col-md-3 equal-height-in">
		...
		<li class="dropdown dropdown-mega">
			<a class="nav-link dropdown-toggle" href="apps.php">Apps</a>
