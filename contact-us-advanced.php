...
<!-- devcode: !production --><html><!-- endcode --><!-- devcode: production --><html><!-- endcode -->
	<head>
		...
		<title>Contact Us Advanced | Porto - Responsive HTML5 Template 6.2.1</title>	
					...
					<div class="row mt-5 pt-2">
									...
									<div class="form-group col-md-4">
										<div class="captcha form-control">
											...
											<div class="captcha-refresh">
												<a href="#" id="refreshCaptcha"><i class="fas fa-refresh"></i></a>
											</div>
										</div>
									</div>
						...
						<div class="col-md-6">
							...
							<ul class="list list-icons list-icons-style-3 mt-4">
								<li><i class="fas fa-map-marker"></i> <strong>Address:</strong> 1234 Street Name, City Name, United States</li>
								<li><i class="fas fa-phone"></i> <strong>Phone:</strong> (123) 456-789</li>
								<li><i class="fas fa-envelope"></i> <strong>Email:</strong> <a href="mailto:mail@example.com">mail@example.com</a></li>
							</ul>
